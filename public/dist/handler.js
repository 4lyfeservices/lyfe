async function __cvHook(e, t = {}, a = "/o/") {
    if ("__cv" in e && e.__cv instanceof ClassicUV) return !1;
    e.document &&
      e.window &&
      e.document
        .querySelectorAll("script[__cv-script]")
        .forEach((e) => e.remove());
    const r = !e.window,
      o = "__cv",
      n = "__cv$",
      l = new ClassicUV({ ...t, window: e });
    ...
    i.nativeMethods.defineProperty(e, "__cv", { value: l, enumerable: !1 }),
    ...
    try {
      ...
      l.bare = e.parent.__cv.bare;
    }
    if (
      ("about:srcdoc" === l.location.href && (l.meta = e.parent.__cv.meta),
      e.EventTarget &&
      ...
      i.nativeMethods.defineProperty(i.storage.storeProto, "__cv$storageObj", {
        get() {
      ...
      for (const t in e.localStorage)
        t.startsWith(n + l.location.origin + "@") &&
          (l.localStorageObj[
            t.slice((n + l.location.origin + "@").length)
    ...
    if (
      ...
      i.history.on("replaceState", (e) => {
        e.data.url &&
          (e.data.url = l.rewriteUrl(
            e.data.url,
            "__cv" in e.that ? e.that.__cv.meta : l.meta
          ));
      }),
      ...
      i.message.on("postMessage", (e) => {
        let t = e.data.origin,
          a = l.call;
        e.that && (a = e.that.__cv$source.call),
          (e.data.origin = "*"),
          (e.data.message = {
            __data: e.data.message,
            __origin: (e.that || e.target).__cv$source.location.origin,
            __to: t
          }),
          e.respondWith(
            a(
      ...
      i.element.hookProperty(p, "contentWindow", {
        get: (e, r) => {
          const o = e.call(r);
          try {
            return o.__cv || __cvHook(o, t, a), o;
          } catch (e) {
            return o;
          }
        }
      ...
      i.element.hookProperty(p, "contentDocument", {
        get: (e, r) => {
          ...
          try {
            ...
            return e.__cv || __cvHook(e, t, a), o;
          } catch (e) {
            return win;
          }
        }
      ...
      i.storage.on("set", (e) => {
        e.that.__cv$storageObj &&
          (e.that.__cv$storageObj[e.data.name] = e.data.value),
          (e.data.name = n + l.meta.url.origin + "@" + e.data.name);
      }),
      i.storage.on("delete", (e) => {
        e.that.__cv$storageObj && delete e.that.__cv$storageObj[e.data.name],
          (e.data.name = n + l.meta.url.origin + "@" + e.data.name);
      }),
      ...
      i.storage.on("clear", (e) => {
        if (e.that.__cv$storageObj)
          for (const t of i.nativeMethods.keys.call(null, e.that.__cv$storageObj))
            delete e.that.__cv$storageObj[t],
      ...
      i.storage.on("length", (e) => {
        e.that.__cv$storageObj &&
          e.respondWith(
            i.nativeMethods.keys.call(null, e.that.__cv$storageObj).length
          );
      }),
      i.storage.on("key", (e) => {
        e.that.__cv$storageObj &&
          e.respondWith(
            i.nativeMethods.keys.call(null, e.that.__cv$storageObj)[
              e.data.index
            ] || null
          );
      }),
      ...
      i.websocket.on("url", (e) => {
        "__cv$url" in e.that && (e.data.value = e.that.__cv$url);
      }),
      i.websocket.on("protocol", (e) => {
        "__cv$protocol" in e.that && (e.data.value = e.that.__cv$protocol);
      }),
    ...
    i.style.on("setCssText", (e) => {
      ...
      i.overrideDescriptor(e, "localStorage", {
        get: (t, a) => (a || e).__cv.lsWrap
      }),
      i.overrideDescriptor(e, "sessionStorage", {
        get: (t, a) => (a || e).__cv.ssWrap
      }),
      ...
      i.nativeMethods.defineProperty(e.Object.prototype, l.methods.top, {
        ...
        get() {
          ...
          if (this === e) {
            ...
            try {
              if ("__cv" in t) return t;
              {
                let e = this;
                for (; e.parent !== t; ) e = e.parent;
                return "__cv" in e ? e : this;
              }
            } catch (e) {
              return this;
            }
  ...
  self.__cv || __cvHook(self, self.__cv$config, self.__cv$config.bare);
